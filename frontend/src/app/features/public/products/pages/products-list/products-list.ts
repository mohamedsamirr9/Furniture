    ...
    this.productService.getProducts(filters).subscribe({
      next: (res: any) => {
        ...
        this.products = data.map((product: any) => ({
          ...
          sellerIsBlocked: product.sellerIsBlocked ?? product.isBlocked ?? product.IsBlocked ?? false,
          isBlocked: product.isBlocked ?? product.IsBlocked ?? product.sellerIsBlocked ?? false,
